...
pretrained_repo = '/home/disk2/csj/MyRetriever/roberta-large'
...
class Sentence_Transformer(nn.Module):
    ...
    def __init__(self, pretrained_repo):
        ...
        self.bert_model = AutoModel.from_pretrained(pretrained_repo,device_map={'': 'cuda:2'})
...
def sber_text2embedding(model, tokenizer, device, text,batch_size):
    try:
