...
class EmbInferDataset:
    ...
    def _process_sample(
        ...
        processed_dict = {
            'id': sample['id'],  # 数据集的id
            'question': question,  # question = sample['question']数据集的问题
            'q_entity': sample['q_entity'],  # 数据集中的q实体
            'q_entity_id_list': q_entity_id_list,  # q实体的list
            'text_entity_list': text_entity_list,  # 所有实体的集合
            'relation_list': relation_list,  # 所有关系的集合
            'h_id_list': h_id_list,  # 头节点的list
            'r_id_list': r_id_list,  # 关系的list
            't_id_list': t_id_list,  # 尾节点的list
            'a_entity': sample['a_entity'],  # 数据集中答案实体
            'a_entity_id_list': a_entity_id_list  # 答案实体的list
        }
